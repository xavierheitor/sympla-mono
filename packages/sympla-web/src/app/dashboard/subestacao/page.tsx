  ...
  const columns = useTableColumnsWithActions<SubestacaoWithRegional>(
    [
      ...
      { title: 'Código SAP', dataIndex: 'codigoSap', key: 'codigoSap' },
      {
        ...
        dataIndex: 'categoria',
        key: 'categoria',
        filters: enums?.categoriaOptions?.map((c) => ({
          text: c.label,
          value: c.value,
        })),
      ...
      },
      {
        ...
        key: 'propriedade',
        filters: enums?.propriedadeOptions?.map((p) => ({
          text: p.label,
          value: p.value,
        })),
      ...
      },
      {
        ...
        dataIndex: 'tensao',
        key: 'tensao',
        filters: enums?.tensaoOptions?.map((t) => ({
          text: t.label,
          value: t.value,
        })),
    ...
    ],
    {
      ...
      onDelete: (item) =>
        controller
          .exec(() => deleteSubestacao(item.id), 'Subestação excluída com sucesso!')
