...
} from '@/lib/actions/tipoManutencao/actionsTipoManutencao';
...
export default function TipoManutencaoPage() {
  ...
  const columns = useTableColumnsWithActions<TipoManutencao>(
    [{ title: 'Nome', dataIndex: 'nome', key: 'nome' }],
    {
      ...
      onDelete: (item) =>
        controller
          .exec(() => deleteTipoManutencao(item.id), 'Tipo de manutenção excluído com sucesso!')
