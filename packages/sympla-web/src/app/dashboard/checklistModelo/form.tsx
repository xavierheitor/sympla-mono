...
import { getAllChecklistModeloTipoAtividadeRelation, getAllChecklistModeloPerguntaRelation } from '@/lib/actions/checklist/actionsChecklistModelo';
import { unwrapFetcher } from '@/lib/utils/fetcherUtils';

interface ChecklistModeloFormProps {
    onSubmit: (values: ChecklistModeloFormData & { tipoAtividadeIds: string[], perguntaIds: string[] }) => void;
