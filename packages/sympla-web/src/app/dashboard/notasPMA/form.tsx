  ...
  useEffect(() => {
    if (initialValues) {
      const convertedDates = {
        ...initialValues,
        dataInicioPlan: initialValues.dataInicioPlan
          ? dayjs(initialValues.dataInicioPlan)
          : undefined,
        dataFiPlan: initialValues.dataFiPlan ? dayjs(initialValues.dataFiPlan) : undefined,
        dataInicioReal: initialValues.dataInicioReal
          ? dayjs(initialValues.dataInicioReal)
          : undefined,
  ...
  return (
    <Form form={form} layout='vertical' onFinish={onSubmit}>
      <Form.Item
        ...
        rules={[{ required: true, message: 'Número da Nota é obrigatório' }]}
      >
        <Input />
      </Form.Item>
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: 'Local de Instalação é obrigatório' }]}
      >
        <Input />
      </Form.Item>
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: 'Data Início Planejado é obrigatório' }]}
      >
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: 'Data Fim Planejado é obrigatório' }]}
      >
        <DatePicker />
      </Form.Item>
      ...
      <Form.Item name='centroTrabalhoId' label='Centro de Trabalho'>
        <Select
          options={centroTrabalhoOptions.map((ct) => ({
            label: ct.nome,
            value: ct.id,
          }))}
        />
      ...
      <Form.Item name='equipamentoId' label='Equipamento'>
        <Select
          options={equipamentoOptions.map((e) => ({
            label: e.nome,
            value: e.id,
          }))}
          showSearch
