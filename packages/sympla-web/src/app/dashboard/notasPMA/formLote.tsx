...
export default function NotaPMALoteForm({ centros, kpis, onSuccess }: Props) {
    ...
    const columns = [
        { title: 'Nota', dataIndex: 'numeroNota', render: renderInput('numeroNota') },
        { title: 'Centro de Trabalho', dataIndex: 'centroTrabalhoNome', render: renderInput('centroTrabalhoNome', centroMap) },
        { title: 'Local de Instalação', dataIndex: 'localInstalacao', render: renderInput('localInstalacao') },
        { title: 'KPI', dataIndex: 'kpiNome', render: renderInput('kpiNome', kpiMap) },
        { title: 'Status', dataIndex: 'statusTexto', render: renderInput('statusTexto', statusMap) },
        { title: 'Mês', dataIndex: 'mesTexto', render: renderInput('mesTexto', meses) },
    ];
